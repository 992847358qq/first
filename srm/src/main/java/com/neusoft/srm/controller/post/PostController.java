...
public class PostController{
  	 ...
  	 * @功能：岗位模块功能操作
  	 * @描述：查询所有岗位信息
  	 *       参数 岗位名称 postName  页码数pageNum  页码类型 pageSize 10条/页   
  	 * @返回值：返回响应信息值
  	 * @作成者：王高亮
  	 * @author WGL
  	 * @作成时间：2018/12/20
	...
	public ServerResponse getListPostController(String postName, @RequestParam(defaultValue = "1") int pageNum,
	...
	public ServerResponse savePost(@ModelAttribute(value = "post") Post post, String loginCode) {
